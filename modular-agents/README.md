...
**Optionally** it is also possible to import some Ragdolls, Skins and materials that are used in different training environments. They work both in PhysX and MuJoCo:
